...
A detailed representation of the structure after an update (v2) can be found in the chapter **[Updating an Object](06_update_object_en.md#3-structure-after-the-update)**.
