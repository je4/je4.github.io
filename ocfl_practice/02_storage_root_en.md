...
-   **`extensions/`**: A directory for extension configurations (see [OCFL Storage Root Extensions](03a_storage_root_extensions_en.md)).

### Important Structure Rules
-   **No Foreign Folders**: In the storage root, the **only** permitted directories are the `extensions` folder (see [OCFL Storage Root Extensions](03a_storage_root_extensions_en.md)) and the directory structures for **OCFL objects**. Other folders are not allowed.
...
4.  **`extensions/`**: Here are the configuration files (`config.json`) for the extensions (see [OCFL Storage Root Extensions](03a_storage_root_extensions_en.md)).
...
[Back to Table of Contents](toc_en.md) | [Next Topic: OCFL Extensions](03_extensions_en.md)
